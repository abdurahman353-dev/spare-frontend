                          ...
                          <div className="space-y-2 pt-1">
                            {order.status === "Shipped" && (
                              <Button
                                ...
                                className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-black uppercase text-[11px] tracking-wider h-11 rounded-xl shadow-sm"
                              >
                            ...
                            <Button
                              ...
                              disabled={markingArrived === order.id}
                              className={`w-full font-black uppercase text-[11px] tracking-wider h-11 rounded-xl shadow-sm ${
